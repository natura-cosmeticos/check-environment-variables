describe('variableCheckers:EmailVariableChecker', function () {
  const { expect } = require('chai')
  const EmailVariableChecker = require('../EmailVariableChecker')

  it('returns an error when variableValue is not an e-mail', function () {
  ...
  it('returns error null when variableValue is an e-mail', function () {
